	    ...
	    <div class="app-content pt-3 p-md-3 p-lg-4">
		    <div class="container-xl">
			    ...
			    <div class="row g-3 mb-4 align-items-center justify-content-between">
				    <div class="col-auto">
			            <h1 class="app-page-title mb-0">Edit Peminjaman Kendaraan</h1>
				    </div>
				...
				<div class="tab-content" id="orders-table-tab-content s">
			        <div class="tab-pane fade show active w-75 " id="orders-all" role="tabpanel" aria-labelledby="orders-all-tab">
					    <div class="app-card app-card-orders-table shadow-sm mb-5">
							<form action="{{ route('peminjamanupdate',$peminjaman->id) }}" method="POST" enctype="multipart/form-data">
                                @csrf
						    <div class="app-card-body p-md-3 ">
                                ...
                                <div class="form-group w-100  mb-3 ">
                                    ...
                                    <input type="text" id="tujuan"  name="tujuan" class="form-control @error('tujuan') is-invalid @enderror" value="{{ old('tujuan',$peminjaman->tujuan) }}"  >
                                    @error('tujuan')
